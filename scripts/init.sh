...
git clone github.com/AntonyLoose/i3-config /home/"$name"/.config/i3
...
git clone https://github.com/AntonyLoose/picom-config /home/"$name"/.config/picom
...
git clone https://github.com/AntonyLoose/kitty-config /home/"$name"/.config/kitty
